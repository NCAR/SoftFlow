...
def parse_args():
    ...
    cfg['app'] = '%s/model.ini.sav'%rrtmgpath 
    #cfg['app'] = '/glade/u/home/youngsun/trepo/temp/cylcworkspace/_yellowstone_ncar_kgen_cesm_rrtmg/output/model.ini'
    ...
    #cfg['runfiles'] = [ '/glade/u/home/youngsun/trepo/temp/cylcworkspace/_yellowstone_ncar_kgen_cesm_rrtmg/output/run_ys_1a_0aM.txt',
    #    '/glade/u/home/youngsun/trepo/temp/cylcworkspace/_yellowstone_ncar_kgen_cesm_rrtmg/output/run_ys_30a_0aM.txt', 
    #    '/glade/u/home/youngsun/trepo/temp/cylcworkspace/_yellowstone_ncar_kgen_cesm_rrtmg/output/run_ys_30a_rand5yM.txt' ]

        #'/glade/p/tdd/asap/kgen_data/cesm_rrtmg_lw/run_ys_26_random.txt' ]
    #cfg['minval'] = None
    #cfg['maxval'] = None
...
def gen_plotpages():
    ...
    #kernel_data = cfg['kernels']['run_ys_1a_0aM.txt']

    pdf = PdfPages('etime_rrtmg_org.pdf')
    ...
    pdf = PdfPages('etime_rrtmg_stat_org.pdf')
    ...
    pdf = PdfPages('etime_rrtmg_adj.pdf')
    ...
    pdf = PdfPages('etime_rrtmg_stat_adj.pdf')
