...
ELSE ()
  ...
  SET(ExtraeS_LIBRARY "-L${EXTRAE_DIR}/lib -lompitracef -L/opt/cray/pe/papi/default/lib -lpapi -L/usr/common/software/libxml2/2.9.3/hsw/lib -lxml2 /usr/lib64/libbfd.a /usr/lib64/libiberty.a")
  #SET(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -L${EXTRAE_DIR}/lib -lompitracef")
  #SET(XML2_LIBRARY "/usr/common/software/libxml2/2.9.3/hsw/lib/libxml2.a")
  #SET(BFD_LIBRARY "/usr/lib64/libbfd.a")
