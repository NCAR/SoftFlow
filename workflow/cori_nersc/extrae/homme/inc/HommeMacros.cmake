...
macro(createTestExec execName execType macroNP macroNC 
  ...
  IF (HAVE_EXTRAE)
    TARGET_LINK_LIBRARIES(${execName} ${ExtraeS_LIBRARY})
    #TARGET_LINK_LIBRARIES(${execName} ${Extrae_LIBRARY})
    #TARGET_LINK_LIBRARIES(${execName} ${XML2_LIBRARY})
    #TARGET_LINK_LIBRARIES(${execName} ${BFD_LIBRARY})
  ENDIF ()
...
macro (copyDirFiles testDir)
  ...
  FOREACH (singleFile ${REFSOLN_FILES}) 
    FILE(COPY ${singleFile} DESTINATION ${testDir})
  ENDFOREACH () 
  FOREACH (singleFile ${EXTRA_NAMELIST_FILES})
    FILE(COPY ${singleFile} DESTINATION ${testDir})
  ENDFOREACH ()
...
macro(printTestSummary)
  ...
  IF (NOT "${REFSOLN_FILES}" STREQUAL "")
    ...
    ENDFOREACH () 
  ENDIF ()
  IF (NOT "${EXTRA_NAMELIST_FILES}" STREQUAL "")
    MESSAGE(STATUS "  extra_namelist_files=")
    FOREACH (singleFile ${EXTRA_NAMELIST_FILES})
      MESSAGE(STATUS "    ${singleFile}")
    ENDFOREACH ()
  ENDIF ()
...
macro(createTest testFile)
  ...
  FILE(GLOB EXTRA_NAMELIST_FILES ${EXTRA_NAMELIST_FILES})
