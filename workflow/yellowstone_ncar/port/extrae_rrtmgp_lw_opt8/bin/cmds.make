...
EXPERIMENT_SRCDIR := /glade/p/tdd/asap/kgen_kernels/port/rrtmgp14_cam5_4_48/rrtmgp_lw.v8
...
copy_experiment:
	...
	cp -f ${INCDIR}/mo_rrtmgp_lw.F90.v8 ${EGROUPDIR}/kernel/mo_rrtmgp_lw.F90
	cp -f ${INCDIR}/radiation.F90.v8 ${EGROUPDIR}/kernel/radiation.F90
	cp -f ${INCDIR}/Makefile.v8 ${EGROUPDIR}/kernel/Makefile
