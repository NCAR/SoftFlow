...
EXTRAE_INSTALLDIR := ${HOME}/opt/extrae/${EXTRAE_VERSION}

# libunwind
# http://download.savannah.gnu.org/releases/libunwind/libunwind-1.2.tar.gz
UNWIND_VERSION := 1.2
UNWIND_INSTALLDIR := ${HOME}/opt/libunwind/${UNWIND_VERSION}

# bin-utils
# http://ftp.gnu.org/gnu/binutils/binutils-2.27.tar.gz
BUTILS_VERSION := 2.27
BUTILS_INSTALLDIR := ${HOME}/opt/binutils/${BUTILS_VERSION}

# libbfd
BFD_VERSION := 2.27
BFD_INSTALLDIR := ${HOME}/opt/binutils/${BUTILS_VERSION}

# libiberty
LIBERTY_VERSION := 2.27
LIBERTY_INSTALLDIR := ${HOME}/opt/binutils/${BUTILS_VERSION}
...
install-binutils:
	...
	cd ${EXTRAETMPDIR}/binutils-${BUTILS_VERSION}; make install
...
install-unwind:
	...
	cd ${EXTRAETMPDIR}/libunwind-${UNWIND_VERSION}; make install
